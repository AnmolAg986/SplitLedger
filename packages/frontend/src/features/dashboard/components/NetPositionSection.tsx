                                  ...
                                  <div className="flex flex-col gap-4 py-4 border-t border-white/5">
                                    ...
                                    {overflowDebts.length > 0 && (
                                      <div className="flex items-center justify-between mt-2 pt-2">
                                         ...
                                         <button onClick={() => navigate('/connections?tab=friends')} className="text-white text-[11px] font-bold border border-white/10 rounded-lg px-4 py-2 hover:bg-white/5 flex flex-col items-center justify-center">
                                           <span>View all</span>
